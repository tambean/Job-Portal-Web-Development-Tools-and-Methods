...
<body>
	...
	<tr>
		...
		<tr>
		<td>${skill}</td>
		<td><a href = 'candidateupdateskill.htm?email=${sessionScope.email}' >Update Skill</a></td>
		</tr>
	</table>
	<br><br>
	...
	<table class="table table-bordered xyz">
		...
		<c:forEach var="experience" items="${experience}">
			<tr>
				...
				<td><a href = 'candidateupdateexperience.htm?email=${sessionScope.email}&Id= ${experience.id}'>Update Experience</a></td>
			</tr>
		</c:forEach>
	</table>
	<br><br>
	<h3>ACADEMIC DETAILS</h3>
	<a href = 'candidateupdateeducation.htm?email=${sessionScope.email}' >Update Education</a>
	<table class="table table-bordered xyz">
		<tr>
